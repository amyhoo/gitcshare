...
//This sample imports subset of folders exported by Export_Partial.java -
//the user specifies what folders to import.
//He may export 4 folders but wants to import only 2 of them. 
//You must specify subset of folders to be imported from specified archived
//
//Run time parameters sample for Export_Partial.java :
//-s BASIC_JAVA  -u user -p pass -a Exp_SDK_Partial  -g http://localhost:9300/p2pd/servlet/dispatch -c Samples -c Samples_Audit
//
//Run time parameters sample for Import_Patrial_Subset.java :
// -s BASIC_JAVA  -u user -p pass -a Exp_SDK_Partial -d imp_Exp_SDK_Partial_2Folders_Sub1 -g http://localhost:9300/p2pd/servlet/dispatch -c Samples 
// -s BASIC_JAVA  -u user -p pass -a Exp_SDK_Partial -d imp_Exp_SDK_Partial_2Folders_Sub2 -g http://localhost:9300/p2pd/servlet/dispatch -c Samples -c Samples_Audit
...
public class Import_Partial_Subset {
	...
	private static final String DEPLOY_OPTION_NAME = "com.cognos.developer.schemas.bibus._3.DeploymentOptionObjectInformationArray";
   	...
   	public static void main(String[] args) 
   	{
		...
		String gateway = "http://localhost:9300/p2pd/servlet/dispatch";
   		...
   		Import_Partial_Subset imp = new Import_Partial_Subset();
