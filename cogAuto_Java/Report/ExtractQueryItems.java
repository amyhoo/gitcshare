...
public class ExtractQueryItems 
{
  ...
  {
		// endpoint URL to CRN
  		String reportNetEndPoint = "http://cogad1.int.corp.sun:9300/p2pd/servlet/dispatch";
  		// search path to the report which will be updated
   		String reportPath = "CAMID('INT:u:0a50606a26a37c4e99d560cfe61b9c2c')/folder[@name='My Folders']/folder[@name='Jean']/analysis[@name='test']";
		...
		sq.logon("INT","S102991","c0gn05batch");
